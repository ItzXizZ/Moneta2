...
if __name__ == '__main__':
    print("[INFO] Starting Moneta with OpenAI API and Memory Search...")
    print("[INFO] Open your browser and go to: http://localhost:4000")
    print("[INFO] Enjoy your purple-themed chat experience!")
    if MEMORY_AVAILABLE:
        print("[INFO] Memory search system is available!")
    else:
