...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Memory Created Notification Styles */
        ...
        .memory-created-header:hover {
            background: rgba(255, 215, 0, 0.1);
            border-bottom-color: rgba(255, 215, 0, 0.35);
        }

        .memory-created-header h4 {
            margin: 0;
        ...
        .memory-created-content.expanded {
            max-height: 400px;
            padding: 12px;
        }
        ...
        .memory-created-item {
            ...
            box-shadow: 
                ...
                inset 0 1px 0 rgba(255, 255, 255, 0.1);
            transition: all 0.3s var(--ease-smooth);
            animation: memoryItemPopIn 0.4s ease-out;
        }

        @keyframes memoryItemPopIn {
            from {
                opacity: 0;
        ...
        .new-thread-btn:active, .end-thread-btn:active, .dashboard-btn:active {
    ...
    <div class="container">
        <div class="thread-sidebar" id="thread-sidebar">
            ...
            <div class="sidebar-controls">
                ...
                <button class="dashboard-btn" onclick="goToDashboard()">Home</button>
            </div>
        </div>
